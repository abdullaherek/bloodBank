...
<!-- 
  ...
  <div class="box" id="box6">Kan Grubunuz:</div>
            ...
            <input class="button" type="submit" name="bagisi_yap" value="Talep Oluşturun" >
        ...
        <?php                  
                        ...
                        if($_POST){
                            ...
                            if(empty($ad) || empty($soyad)  || empty($ilceID) || empty($kan_gruplariID)   ) {
                               ...
                               $addForms_stmt = $pdo->prepare("INSERT INTO ihtiyac_bilgi (ad, soyad, ilID, ilceID,tel_no, kan_gruplariID, kayit_id)
